              ...
              <thead className="bg-slate-700/50 sticky top-0">
                <tr>
                  {selectedReport === "governance" ? (
                    ...
                    <>
                      <th className="px-4 py-3 text-left font-semibold text-slate-300">Order Code</th>
                      ...
                      <th className="px-4 py-3 text-left font-semibold text-slate-300">Owner</th>
                    </>
                  )}
                </tr>
              </thead>
                  ...
                  <tr key={item.id || idx} className="hover:bg-slate-700/30 transition">
                    {selectedReport === "governance" ? (
                      <>
                        ...
                        <td className="px-4 py-3 text-slate-300">{item.unit?.name || item.unit?.code || "—"}</td>
                      ...
                      <>
                        <td className="px-4 py-3 font-mono text-xs text-blue-400">{item.orderCode}</td>
                        <td className="px-4 py-3 font-medium text-white max-w-[250px] truncate">{item.name}</td>
                        <td className="px-4 py-3 text-slate-300">{item.unit?.name || item.unit?.code || "—"}</td>
                        <td className="px-4 py-3"><StatusBadge status={item.status} /></td>
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs text-slate-400">{item.percentComplete || 0}%</span>
                          </div>
                        </td>
